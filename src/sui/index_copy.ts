...
export function createSuiAddress(seedHex: string, receiveOrChange: string, addressIndex: string, network: string): any {
...
export async function signSuiTransaction(params: any): Promise<string> {
    const {
